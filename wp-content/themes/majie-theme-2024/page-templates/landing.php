...
<div class="ctas">
  ...
  <div class="cta cta_support">
    <a href="<?= $donations_link ?>" target="_blank">
      <svg
        version="1.1"
        id="lni_lni-revenue"
        xmlns="http://www.w3.org/2000/svg"
...
<div class="landing">
  ...
  <section class="landing__content">
    <?php if ($news['active'] && strlen($news['content']) > 0) { ?>
      <div class="landing__content__news" id="news">
        <div class="landing__content__news__title">
          <h2 class="reveal"><?= $news['title']; ?></h2>
        </div>
        <div class="landing__content__news__content reveal">
          <?= $news['content']; ?>
        </div>
      </div>
    <?php }; ?>
    <?php if (strlen($who_are_we['content']) > 0) { ?>
      <div class="landing__content__who_are_we" id="who_are_we">
        <div class="landing__content__who_are_we__title">
          <h2 class="reveal"><?= $who_are_we['title'] ?></h2>
        </div>
        <div class="landing__content__who_are_we__content reveal">
          <?= $who_are_we['content'] ?>
        </div>
      </div>
    <?php }; ?>
    <?php if (strlen($activities['content']) > 0) { ?>
      <div class="landing__content__activities" id="activities">
        <div class="landing__content__activities__title">
          <h2 class="reveal"><?= $activities['title'] ?></h2>
        </div>
        <div class="landing__content__activities__content reveal">
          <?= $activities['content'] ?>
        </div>
      </div>
    <?php }; ?>
    <div class="landing__content__partners" id="partners">
      <div class="landing__content__partners__title">
      <h2 class="reveal"><?= $partners['title'] ?></h2>
      </div>
      <div class="landing__content__partners__work reveal">
      ...
      <div class="landing__content__partners__links reveal">
      ...
      <div class="landing__content__partners__find_us reveal">
      ...
      <div class="landing__content__partners__funders reveal">
    ...
    <div class="landing__content__support" id="support">
    <?php if (strlen($support['title'])>0) { ?>
      <div class="landing__content__support__title">
        <h2 class="reveal"><?= $support['title'] ?></h2>
      </div>
      <?php if (sizeof($support['emergency'])>1) { ?>
        <div class="landing__content__support__emergency reveal">
          <div class="tit">
            <h3>
      ...
      <?php if (strlen($support['needs']['title'])>0 && strlen($support['needs']['content'])>0) { ?>
        <div class="landing__content__support__needs reveal">
          <div class="title">
            <h3>
              <?= $support['needs']['title']; ?>
            </h3>
      ...
      <?php if (strlen($support['donations']['title'])>0 && strlen($support['donations']['content'])>0) { ?>
        <div class="landing__content__support__donations reveal">
          <div class="title">
            <h3>
    ...
    <div class="landing__content__contact" id="contact">
      <div class="landing__content__contact__title">
        <h2 class="reveal">Nous contacter</h2>
      </div>
      <div class="landing__content__contact__infos reveal">
      ...
      <div class="landing__content__contact__form reveal">
